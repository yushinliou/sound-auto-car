...
export default class IntroSection
{
    constructor(_options)
    {
        ...
        // this.setTitles() // Removed: BRUNO SIMON letter blocks
        this.setTiles()
        this.setDikes()
    }
    ...
    // setTitles() - REMOVED: BRUNO SIMON letter blocks
    // Method commented out to remove 3D text blocks from scene
    setTitles()
    {
        // All letter blocks removed for research purposes
    }
